...
#added code for ISO-9241-11 / added by me
  ...
  def _determine_target(self):
    ...
    cAngle = self.calculatePos(cPosition, ( numBalls / 2 ), ( numBalls / 2 ) - 1) + 1
    limit_r = self._target_limits_y[1]
    ...
    size = self._target_radius_limit[0] + ((self._target_radius_limit[1] - self._target_radius_limit[0]) / numSizes) * ( cSize + 1 )   
    return y,z,size
