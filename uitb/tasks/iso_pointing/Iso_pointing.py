...
#added code for ISO-9241-11 / added by me
  def _determine_Pos(self):
      ...
      num_of_diff_radius = 15 #Anzahl verschiedener Kreise
  ...
  def _determine_Size(self):
      #Fixed Parameters
      num_of_diff_target_sizes = 6 #Anzahl verschiedener Targetgrößen
      
      #Create a random value to calculate the size of the target
      r_size = np.random.randint(0,num_of_diff_target_sizes) #verschiedene größen für einen Kreis
